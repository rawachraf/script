# VID PROF : https://www.youtube.com/watch?v=ZDzzJgGiVcQ&t=1s

javascript: void(function() {
    alert('DESEJA CUTUCAR TODOS AMIGOS DO FACEBOOK? - POKE ALL FRIENDS FACEBOOK?');
    ...
    setTimeout(function() {
        alert('AMIGOS CUTUCADOS COM SUCESSO / FACEBOOK FRIEND POKE')
    }, 5000);
})();